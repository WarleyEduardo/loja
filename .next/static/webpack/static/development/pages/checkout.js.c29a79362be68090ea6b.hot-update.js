...
var pagarPedido = function pagarPedido(id, token, senderHash) {
  return function (dispatch) {
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.post("".concat(_config__WEBPACK_IMPORTED_MODULE_3__["url"], "/api/pedidos/loja=").concat(_config__WEBPACK_IMPORTED_MODULE_3__["loja"])), {}, Object(_helpers__WEBPACK_IMPORTED_MODULE_5__["getHeaders"])(token).then(function (response) {
      dispatch({
        type: NOVO_PEDIDO,
        payload: response.data
      });
...
//# sourceMappingURL=checkout.js.c29a79362be68090ea6b.hot-update.js.map