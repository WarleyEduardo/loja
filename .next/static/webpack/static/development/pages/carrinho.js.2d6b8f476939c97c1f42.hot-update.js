    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (carrinho && carrinho[0] && carrinho[0].produto && !carrinho[0].produto._id) {
        carrinho.forEach(function (item, idx) {
          console.log('entrou aqui', item.produto);
          _this.props.fetchProdutoCarrinho(item.produto, idx);
          if (item.produto.titulo) _this.props.fetchVariacoesCarrinho(item.variacao, item.produto, idx);
        });
      }
    }
  }, {
...
//# sourceMappingURL=carrinho.js.2d6b8f476939c97c1f42.hot-update.js.map