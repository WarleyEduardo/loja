...
var CarrinhoContainer = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(CarrinhoContainer, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      console.log('passou no carrinho ', carrinho);
      if (carrinho && carrinho[0] && carrinho[0].produto && !carrinho[0].produto._id) {
        carrinho.forEach(function (item, idx) {
          console.log('item:', item.variacao);
          if (item.variacao) console.log('possui variacação', item.variacao);
          if (item.variacao) _this.props.fetchVariacoesCarrinho(item.variacao, item.produto, idx);
        });
      }
    }
  }, {
...
//# sourceMappingURL=carrinho.js.f79b49746dd40caffc40.hot-update.js.map