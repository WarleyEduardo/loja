...
var fetchPedido = function fetchPedido(_ref3) {
  var pedido = _ref3.pedido,
    token = _ref3.token;
  return function (dispatch) {
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get("".concat(_config__WEBPACK_IMPORTED_MODULE_2__["url"], "/api/pedidos/").concat(pedido, "?loja=").concat(_config__WEBPACK_IMPORTED_MODULE_2__["loja"]), Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["getHeaders"])(token)).then(function (response) {
      return dispatch({
...
//# sourceMappingURL=area-cliente.js.51ec4275b0e023176115.hot-update.js.map